        ...
        <script type="text/javascript">
	        ...
	        tableConfig.formatters = {
        		"commands": function(column, row) {
                	...
                	return " <a href=\"ViewContactUsMessages?id=" + row.id + "&email=" + row.email+"&status=" + row.status+"\" class=\"btn btn-sm btn-warning command-reply\" data-row-id=\"" + row.id + "\" data-row-status=\"" + row.status + "\">View</a> "+
