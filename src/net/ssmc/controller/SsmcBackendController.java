...
public class SsmcBackendController {
	...
	@RequestMapping(path="/RegisteredAccounts", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@AppicationAudit(module = Module.CONTACTINFORMATION, access = Access.DELETE)
